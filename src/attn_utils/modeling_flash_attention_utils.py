...
from .fa2_utils import is_flash_attn_2_available, is_flash_attn_greater_or_equal
...
def fa_peft_integration_check(
    ...
    raise NotImplementedError('We do not use peft')
...
def _flash_attention_forward(
    ...
    **kwargs,
    ...
    if attention_mask is not None:
        ...
        # assert ((attn_output - attn_output1) == 0).all()
